  ...
  return (
    ...
    <header className="fixed top-0 left-0 flex-cols  flex-wrap md: w-full  z-50 flex justify-between items-center px-10 py-4 shadow-md bg-[#FFFFFF]">
      ...
      <div className="flex items-center space-x-2">
        ...
        />
        <span className="text-2xl font-bold text-black tracking-tight">Furniro</span>
      </div>

      {/* Navigation Links */}
      <nav className="flex flex-wrap md:flex space-x-8 text-lg">
      ...
      {/* Icons */}
      <div className="flex space-x-4 sm:space-x-6 text-lg  text-black">
        <NavIcons/>
       </div>
    </header>
  );
